...
$arrOverride=array('630000002865'=>sha1('630000002865'),'630000125392'=>sha1('630000125392'));
...
if(isset($_POST['submit'])){
	...
	if($dist_num==0&&mysqli_num_rows($check_acct)==0){	//check if acct exists
		...
		if($dist_num>0){
			...
			if(($_SESSION['u_site']==CRIS||$_SESSION['u_site']==REPZ)) $_SESSION['super_user']=true;
		}
	...
	}if($_SESSION['isLogged']) { reloadTo('/read/'.$shortlink.'account/');exit; }
}reloadTo('/login');
