...
function getWHID($user) {
	...
	$rs=mysqli_query($con,"SELECT id,wh,dsdid,bond FROM tblwarehouse WHERE id='$user' AND status=1") or die(mysqli_error($con));
