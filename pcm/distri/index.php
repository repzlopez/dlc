...
while( $r=mysqli_fetch_assoc($rs) ) {
     ...
     if ( $old<$new ) {
          ...
          $x .= ( IS_PCM ? '<span class="s3">Branch</span>' :'' );
	...
	$x .= '<li rel="'.$r['dsdid'].'">';
     ...
     $x .= ( IS_PCM ? '<span class="s3">'.$r['referrer'].'</span>' :'' );
...
if ( !IS_PCM ) $x .= '<li><br><a href="../../reg"><span id="addnew"></span>ADD REQUEST</a></li>';
$x .= '</ul>';
