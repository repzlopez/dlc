...
if($do==0){$d=0;
	...
	if($do==1){
		...
		$msg.='<li><label>Image:</label><input type="file" name="file_img" /><input type="text" name="img" value="" '.READONLY.' /></li>';
		$msg.='<li><label>Download:</label><input type="file" name="upfile" /><input type="text" name="dlfile" value="" '.READONLY.' /></li>';
		...
		while($rw=mysqli_fetch_assoc($rs)){
			...
			$msg.='<li><label>Image:</label><input type="file" name="file_img" /><input type="text" name="img" value="'.$rw['img'].'" '.READONLY.' /></li>';
			$msg.='<li><label>Download:</label><input type="file" name="upfile" /><input type="text" name="dlfile" value="'.$rw['dlfile'].'" '.READONLY.' /></li>';
