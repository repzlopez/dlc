...
$con->query("UPDATE tblorders SET status=9 WHERE refno='$trans'") or die(mysqli_error($con));
$con->query("INSERT INTO tbllog VALUES (null,'$trans','" . date(TMDSET, time()) . "',9,'" . LOGIN_ID . "')") or die(mysqli_error($con));
