...
if(isset($_POST['submit']) && $_POST['submit'] == 'Submit') {
	...
	if (!testExist($un, 'products', 'tblwarehouse', 'id')) {
		$_SESSION['post']['bad_distri'] = 'Unable to continue. Warehouse ID not found. Setup Warehouse ID first.';

	} elseif (testExist($un, 'gos', 'tbladmin', 'un') && $do < 2) {
		$_SESSION['post']['bad_distri'] = 'Unable to continue. User exists.';

	} elseif ($do == 1 && $reqmiss > 0) {
