...
$_SESSION['order_type'] = substr(stristr($_SERVER['REQUEST_URI'], '?'), 1);
...
function loadFilters() {
	...
	$data .= '</ul></div>';
	$data .= '<div id="center_products"><strong class="blue">AVAILABLE PRODUCTS</strong> (<span class="ital">Found <strong id="gos_found" class="blue"></strong> products</span>)<ul class="list clear">';
	$data .= '</ul></div>';
